...
- [WWW-Talk (Oct 15, 1993): Browser capabilities chart](https://ksi.cpsc.ucalgary.ca/archives/WWW-TALK/www-talk-1993q4.messages/222.html) - Pei Wei's chart showing ViolaWWW as the only browser with stylesheet support (`uie` status)
