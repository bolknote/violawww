 ...
 */
extern HTStream* HTMIMEConvert PARAMS((HTPresentation * pres, HTParentAnchor* anchor,
                                       HTStream* sink));
/*
 ...
 */
extern HTStream* HTNetMIME PARAMS((HTPresentation * pres, HTParentAnchor* anchor, HTStream* sink));
