...
The `<FIGURE>` element was [proposed by Pei-Yuan Wei in May 1993](https://ksi.cpsc.ucalgary.ca/archives/WWW-TALK/www-talk-1993q2.messages/409.html) on the www-talk mailing list and later included in the [HTML+ DTD specification](https://www.w3.org/MarkUp/HTMLPlus/htmlplusdtd.txt) by Dave Raggett. It predated the standardization of the `<IMG>` tag and provided features later adopted in HTML standards:
