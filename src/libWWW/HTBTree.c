    ...
    if (tree->top == NULL) {
        ...
        while (father_found) {
            if (tree->compare(object, father_of_element->object) < 0) {
                if (father_of_element->left != NULL)
                    ...
                    father_found = NO;
                    father_of_element->left = (HTBTElement*)malloc(sizeof(HTBTElement));
                    if (father_of_element->left == NULL)
                        outofmem(__FILE__, "HTBTree_add");
            ...
            if (tree->compare(object, father_of_element->object) >= 0) {
                if (father_of_element->right != NULL)
                    ...
                    father_found = NO;
                    father_of_element->right = (HTBTElement*)malloc(sizeof(HTBTElement));
                    if (father_of_element->right == NULL)
                        outofmem(__FILE__, "HTBTree_add");
        ...
        */
        ...
        do {
            if (father_of_forefather->left == forefather_of_element) {
                ...
                father_of_forefather->left_depth = 1 + MAXIMUM(forefather_of_element->right_depth,
                                                               forefather_of_element->left_depth);
                depth2 = father_of_forefather->left_depth;
            } else {
                depth = father_of_forefather->right_depth;
                father_of_forefather->right_depth = 1 + MAXIMUM(forefather_of_element->right_depth,
                                                                forefather_of_element->left_depth);
        ...
        */
        ...
        while ((top_found) && (first_correction)) {
            if ((abs(father_of_element->left_depth - father_of_element->right_depth)) < 2) {
                ...
                */
                ...
                if (father_of_element->left_depth > father_of_element->right_depth) {
                    ...
                    added_element->right_depth =
                        1 + MAXIMUM(father_of_element->right_depth, father_of_element->left_depth);
                    if (father_of_element->up != NULL) {
                        ...
                        do {
                            if (father_of_forefather->left == forefather_of_element->up) {
                                depth = father_of_forefather->left_depth;
                                father_of_forefather->left_depth =
                                    1 + MAXIMUM(forefather_of_element->left_depth,
                                                forefather_of_element->right_depth);
                                depth2 = father_of_forefather->left_depth;
                            } else {
                                depth = father_of_forefather->right_depth;
                                father_of_forefather->right_depth =
                                    1 + MAXIMUM(forefather_of_element->left_depth,
                                                forefather_of_element->right_depth);
                                depth2 = father_of_forefather->right_depth;
                            }
                    ...
                    if (father_of_element->up != NULL) {
                        ...
                        do {
                            if (father_of_forefather->left == father_of_element) {
                                ...
                                father_of_forefather->left_depth =
                                    1 +
                                    MAXIMUM(added_element->left_depth, added_element->right_depth);
                                depth2 = father_of_forefather->left_depth;
                            } else {
                                depth = father_of_forefather->right_depth;
                                father_of_forefather->right_depth =
    ...
    */
    if (father_of_element != NULL) {
        ...
        if (father_of_element->up != NULL)
            ...
            printf("Pas de Pere\n");
        if (father_of_element->left != NULL)
            printf("Objet du fils gauche = %s\t", (char*)father_of_element->left->object);
        else
