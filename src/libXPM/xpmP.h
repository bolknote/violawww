...
FUNC(xpmParseData, int,
     (xpmData * data, xpmInternAttrib* attrib_return, XpmAttributes* attributes));

FUNC(xpmScanImage, int,
     (Display * display, XImage* image, XImage* shapeimage, XpmAttributes* attributes,
...
FUNC(xpmSetAttributes, int, (xpmInternAttrib * attrib, XpmAttributes* attributes));

FUNC(xpmGetAttributes, int, (XpmAttributes * attributes, xpmInternAttrib* attrib));
...
FUNC(xpm_xynormalizeimagebits, int, (unsigned char* bp, XImage* img));
FUNC(xpm_znormalizeimagebits, int, (unsigned char* bp, XImage* img));
